...
import { DocumentAttribute, DocumentEvent, VUIDocument } from "../document";

export class ElementCompletionProvider
  implements CompletionItemProvider<CompletionItem>
{
  ...
  getAttrValues(tag: string, attr: string): string[] {
    const document: Record<string, any> = VUIDocument;
