...
import { DocumentScopedSlot } from "../";
...
export const attributes: DocumentAttribute[] = [
  ...
  {
    name: "children",
    description: "specify which node object is used as the node's subtree",
    type: "string",
    value: "—",
    default: "—",
  },
...
export const methods: DocumentMethod[] = [
  ...
  },
  {
    ...
    parameter:
      "(key) the node's key to be highlighted. If `null`, cancel the currently highlighted node",
  },
  {
    name: "setCurrentNode",
