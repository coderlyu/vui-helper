...
export const methods: DocumentMethod[] = [
  {
    ...
    parameter:
      "index of the slide to be switched to, starting from 0; or the `name` of corresponding `el-carousel-item`",
  },
...
export const events: DocumentEvent[] = [
  {
    ...
    parameter: "index of the new active slide, index of the old active slide",
  },
];
