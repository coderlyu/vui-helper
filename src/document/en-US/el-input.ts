...
export const attributes: DocumentAttribute[] = [
  {
    ...
    type: "string",
    value:
      "text, textarea and other [native input types](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Form_%3Cinput%3E_types)",
    default: "text",
  },
  {
    name: "value/v-model",
  ...
  {
    name: "auto-complete",
    description: "@DEPRECATED in next major version",
    type: "string",
    value: "on/off",
    default: "off",
  },
...
export const slots: DocumentSlot[] = [
  ...
  },
  {
    name: "prepend",
    description:
      "content to prepend before Input, only works when `type` is 'text'",
  },
  {
    name: "append",
    description:
      "content to append after Input, only works when `type` is 'text'",
  },
];
