...
export const attributes: DocumentAttribute[] = [
  ...
  },
  {
    name: "accept",
    description:
      'accepted [file types](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-accept), will not work when `thumbnail-mode` is `"true"`',
    type: "string",
    value: "—",
    default: "—",
  },
...
export const methods: DocumentMethod[] = [
  {
    name: "clearFiles",
    description:
      "clear the uploaded file list (this method is not supported in the `before-upload` hook)",
    parameter: "—",
  },
  {
    name: "abort",
    description: "cancel upload request",
    parameter: "（ file: fileList's item ）",
  },
  {
    name: "submit",
