...
export const slots: DocumentSlot[] = [
  { name: "range-separator", description: "custom range separator content" },
];
...
export const pickerOptions: DocumentAttribute[] = [
  ...
  },
  {
    name: "onPick",
    description:
      "a callback that triggers when the selected date is changed. Only for daterange and datetimerange.",
