...
export const attributes: DocumentAttribute[] = [
  ...
  },
  {
    name: "visible-arrow",
    description:
      "whether an arrow is displayed. For more information, check [Vue-popper](https://github.com/element-component/vue-popper) page",
    type: "boolean",
    value: "—",
    default: "true",
  },
  {
    name: "popper-options",
    description:
      "[popper.js](https://popper.js.org/documentation.html) parameters",
    type: "Object",
  ...
  },
  {
    name: "tabindex",
    description:
      "[tabindex](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex) of Tooltip",
    type: "number",
    value: "—",
    default: "0",
  },
