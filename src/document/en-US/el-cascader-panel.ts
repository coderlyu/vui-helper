...
export const methods: DocumentMethod[] = [
  {
    ...
    parameter:
      "(leafOnly) whether only return the leaf checked nodes, default is `false`",
  },
  {
...
export const events: DocumentEvent[] = [
  ...
  },
  {
    ...
    parameter: "an array of the expanding node's parent nodes",
  },
];
...
export const props = [
  ...
  },
  {
    name: "lazyLoad",
    description:
      "method for loading child nodes data, only works when `lazy` is true",
  },
  {
    name: "value",
  ...
  },
  {
    name: "disabled",
    description:
      "specify which key of node object is used as the node's disabled",
  },
  {
    name: "leaf",
    description:
