...
export const attributes: DocumentAttribute[] = [
  ...
  },
  {
    name: "visible-arrow",
    description:
      "whether a tooltip arrow is displayed or not. For more info, please refer to [Vue-popper](https://github.com/element-component/vue-popper)",
    type: "boolean",
    value: "—",
    default: "true",
  },
  {
    name: "popper-options",
    description:
      "parameters for [popper.js](https://popper.js.org/documentation.html)",
    type: "object",
    value:
      "please refer to [popper.js](https://popper.js.org/documentation.html)",
