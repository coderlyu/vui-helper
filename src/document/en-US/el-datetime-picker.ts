...
export const attributes: DocumentAttribute[] = [
  ...
  },
  {
    ...
    type: "string",
    value: "year/month/date/datetime/ week/datetimerange/daterange",
    default: "date",
  },
  {
    name: "format",
  ...
  {
    name: "popper-class",
    description: "custom class name for DateTimePicker's dropdown",
    type: "string",
    value: "—",
    default: "—",
  },
  ...
  },
  {
    ...
    type: "Date",
    value: "anything accepted by `new Date()`",
    default: "—",
  },
  {
    name: "default-time",
    ...
    value:
      "non-range: a string like `12:00:00`, range: array of two strings, and the first item is for the start date and second for the end date. `00:00:00` will be used if not specified",
    default: "—",
  },
  {
    name: "value-format",
  ...
  {
    name: "unlink-panels",
    description: "unllink two date-panels in range-picker",
    type: "boolean",
    value: "—",
    default: "false",
  },
...
export const events: DocumentEvent[] = [
  {
    ...
    parameter: "component's binding value",
  },
  {
    name: "blur",
    description: "triggers when Input blurs",
    parameter: "component instance",
  },
  {
    name: "focus",
...
export const pickerOptions: DocumentAttribute[] = [
  {
    ...
    description:
      "available time range, e.g.'18:30:00 - 20:30:00'or['09:30:00 - 12:00:00', '14:30:00 - 18:30:00']",
    type: "string / array",
    value: "—",
    default: "—",
  },
